...
from utils.common import MOD_NAMES, GROUP_TO_INDEX, INDEX_TO_NUCLEOTIDE, GROUP_TO_CLASS_INDICES
...
def evaluate_balanceb(y_true: np.ndarray, y_prob: np.ndarray, y_4class: np.ndarray,
    ...
    for g in range(4):
        ...
        if y_4prob is not None:
            ...
            class_indices = GROUP_TO_CLASS_INDICES[g]
    ...
    all_f1_4, all_prec_4, all_rec_4 = [], [], []
    for g in range(4):
        all_f1_4.append(metrics[f'group_4class_{g}_opt_f1'])
