...
Smoke test (legacy):
    python ipynb/motif/gen3_localized_ig_motif_ig_sankey.py \
      --config json/3gen.json \
      --checkpoint logs/old/rna_classification_20260129_195404/checkpoints/epoch_090.pt \
      --output_dir ipynb/motif/output/debug_gen3_ig_sankey \
...
Smoke test (ig_attention_stage):
    python ipynb/motif/gen3_localized_ig_motif_ig_sankey.py \
      --config json/3gen.json \
      --checkpoint logs/old/rna_classification_20260129_195404/checkpoints/epoch_090.pt \
      --output_dir ipynb/motif/output/debug_gen3_ig_attn_stage_sankey \
      --mods m6A --sample_size 20 --top_k 2 --ig_steps 8 \
      --skip_external_tools --batch_size 1 --device cuda \
...
def main():
    ...
    p = argparse.ArgumentParser(description='Gen3 localized IG motif analysis with Sankey visualization (v2)')
    ...
    p.add_argument('--output_dir', default=os.path.join(PROJECT_ROOT, 'ipynb', 'motif_apply', 'output', 'gen3', 'ig_attn_stage_sankey'))
