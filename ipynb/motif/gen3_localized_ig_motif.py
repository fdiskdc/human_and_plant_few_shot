...
def run_pipeline(args):
    ...
    # ---- Full-data analysis ----
    # 中文：motif 分析使用全量 Gen3 数据，不再先构造 train/test split。
    # English: motif analysis uses the full Gen3 dataset; no train/test split is created here.
...
def main():
    ...
    p.add_argument('--output_dir', default=os.path.join(PROJECT_ROOT, 'ipynb', 'motif', 'output', 'localized_ig_gen3'))
