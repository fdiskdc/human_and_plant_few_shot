#!/usr/bin/env python3
"""
human_localized_ig_motif_ig_sankey.py
...
Smoke test (ig_attention_stage):
    python ipynb/motif/human_localized_ig_motif_ig_sankey.py \
      --config json/human.json \
      --checkpoint logs/old/rna_classification_20260129_195404/checkpoints/epoch_090.pt \
      --output_dir ipynb/motif/output/debug_ig_attn_stage_sankey \
      --mods m6A --sample_size 20 --top_k 2 --ig_steps 8 \
      --skip_external_tools --batch_size 1 --device cuda \
...
def main():
    ...
    p = argparse.ArgumentParser(description='Localized IG motif analysis with Sankey visualization (v2)')
