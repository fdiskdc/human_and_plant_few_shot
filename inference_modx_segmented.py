"""
ModX Segmented Inference — 101nt Sliding Window

Uses the adapted modx checkpoint (BiLSTM + BahdanauAttention) trained on human data.
Runs 101nt sliding windows (stride=50) over 1001nt sequences.
Collects attention per window and stitches back to full-length [N, 12, 1001].

Output: npy/modx_segmented_atten.npz
"""
